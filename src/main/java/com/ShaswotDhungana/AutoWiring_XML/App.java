package com.ShaswotDhungana.AutoWiring_XML;
...
public class App {
	...
	public static void main(String[] args) {
		...
		ApplicationContext appContext = new ClassPathXmlApplicationContext("com/ShaswotDhungana/AutoWiring_XML/autoWiringConfig.xml");
