...
public class App {
	...
	public static void main(String[] args) {
		...
		AbstractApplicationContext appContext = new ClassPathXmlApplicationContext("com/ShaswotDhungana/SpringBean_LifeCycle_Implementation_Annotations/config.xml");
